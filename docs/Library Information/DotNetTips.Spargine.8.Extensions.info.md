...
### Task<List<T>> ToListAsync(IEnumerable<T> collection)
...
### Task<T> GetAndDeserializeAsync(HttpClient client, Uri url, JsonSerializerOptions options)
...
### Task<Byte[]> GetRawBodyBytesAsync(HttpRequest request)
...
### Task<String> GetRawBodyStringAsync(HttpRequest request, Encoding encoding)
...
### Task<String> FromBrotliStringAsync(String value)
...
### Task<String> FromDeflateStringAsync(String value)
...
### Task<String> FromGZipStringAsync(String value)
...
### Task<String> FromZLibStringAsync(String value)
...
### Task<String> ToBrotliStringAsync(String input, CompressionLevel level)
...
### Task<String> ToDeflateStringAsync(String input, CompressionLevel level)
...
### Task<String> ToGZipStringAsync(String input, CompressionLevel level)
...
### Task<String> ToZLibStringAsync(String input, CompressionLevel level)
