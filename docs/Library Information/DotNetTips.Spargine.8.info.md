# DotNetTips.Spargine.8 - 2025.8.3.15
...
### Void StartServices(IEnumerable`1& requests)
...
### Void StartStopServices(IEnumerable`1& requests)
...
### Void StopServices(IEnumerable`1& requests)
...
### Void RemoveAttributes(DirectoryInfo path, FileAttributes& attributesToRemove)
...
### Task<SimpleResult<Int32>> DownloadFileFromWebAsync(Uri remoteUri, DirectoryInfo destination, CancellationToken cancellationToken)
...
### Int32 CopyFiles(IEnumerable`1& files, DirectoryInfo destination)
...
### Int32 DeleteFiles(IEnumerable`1& files)
