# DotNetTips.Spargine.8 - 2025.8.1.15
...
### Task<HttpResponseMessage> GetHttpResponseAsync(Uri url)
...
### Task<HttpResponseMessage> GetHttpResponseAsync(Uri url, CancellationTokenSource cancellationToken)
...
### IAsyncEnumerable<IEnumerable<FileInfo>> LoadFilesAsync(IEnumerable<DirectoryInfo> directories, String searchPattern, SearchOption searchOption)
...
### Task<Int64> CopyFileAsync(FileInfo file, DirectoryInfo destination)
...
### Task DownloadFileFromWebAndUnzipAsync(Uri remoteUri, DirectoryInfo destination)
...
### Task DownloadFileFromWebAsync(Uri remoteUri, DirectoryInfo destination)
...
### Task UnGZipAsync(FileInfo file, DirectoryInfo destination)
...
### Task UnGZipAsync(FileInfo file, DirectoryInfo destination, Boolean deleteGZipFile)
...
### Task UnWinZipAsync(String zipPath, String expandedDirectoryPath)
...
### Task UnZipAsync(FileInfo file, DirectoryInfo destination)
...
### Task UnZipAsync(FileInfo file, DirectoryInfo destination, Boolean deleteZipFile)
