# DotNetTips.Spargine.8.Core - 2025.8.2.23
...
### ReadOnlyCollection<String> LogicalDrives { get; set; }
...
### String CombineStrings(Boolean addLineFeed, String[] args)
...
### String ConcatStrings(Char delimiter, Boolean addLineFeed, String[] args)
...
* **Unit Test Status:** Completed
* **Author:** David McCarter
* **CreatedOn:** 12/28/2022
* **Description:** ConcatStrings
* **Documentation:** https://bit.ly/SpargineFeb2023
* **Modified By:** David McCarter

### String ConcatStrings(String delimiter, Boolean addLineFeed, String[] args)
...
### FastSortedList<T> (IEnumerable<T> collection)
...
### FastSortedList<T> (IEnumerable<T> collection, IComparer<T> comparer)
...
### ObservableList<T> (IEnumerable<T> collection)
...
### ObservableList<T> (IEnumerable<T> collection, IEqualityComparer<T> comparer)
...
### ConcurrentHashSet<T> (IEnumerable<T> collection)
...
### ConcurrentHashSet<T> (IEnumerable<T> collection, IEqualityComparer<T> comparer)
...
### ConcurrentHashSet<T> (Int32 concurrencyLevel, IEnumerable<T> collection, IEqualityComparer<T> comparer)
...
### DistinctConcurrentBag<T> (IEnumerable<T> collection)
...
*****
**Generated by Spargine - dotNetTips.com on 2/25/2025 5:25:45 PM UTC**
