# DotNetTips.Spargine.8.Core - 2025.8.3.4
...
### String AppendFormat(String format, String[] args)
...
### String Replace(String original, String replacement, String input)
...
### String Substring(String input, Int32& startIndex, Int32& length)
