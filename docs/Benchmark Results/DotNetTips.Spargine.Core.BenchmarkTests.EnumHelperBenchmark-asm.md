...
; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetValues()
       ...
       xor       ecx,ecx
       xor       edx,edx
       call      qword ptr [7FF983707C78]; DotNetTips.Spargine.Core.EnumHelper.GetValues[[System.Net.Cache.RequestCacheLevel, System.Net.Primitives]](Boolean, Boolean)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; DotNetTips.Spargine.Core.EnumHelper.GetValues[[System.Net.Cache.RequestCacheLevel, System.Net.Primitives]](Boolean, Boolean)
       ...
       je        near ptr M01_L37
       mov       rcx,240FAB445A8
       call      qword ptr [7FF982DB4990]; System.Enum.GetValuesAsUnderlyingTypeNoCopy(System.RuntimeType)
       mov       rdi,rax
       mov       r8d,[rdi+8]
       test      r8d,r8d
       jl        near ptr M01_L36
...
M01_L05:
       ...
       call      qword ptr [7FF9830D4BD0]; System.RuntimeType+ListBuilder`1[[System.__Canon, System.Private.CoreLib]].Add(System.__Canon)
M01_L06:
       inc       r13d
       cmp       r15d,r13d
       jg        short M01_L05
...
M01_L11:
       ...
       mov       rdx,240FAB445F8
       mov       r8d,1
       call      qword ptr [7FF9830D4168]; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       test      rax,rax
       je        short M01_L12
...
M01_L17:
       ...
       call      qword ptr [7FF9837A5080]; System.Collections.Immutable.ImmutableExtensions.ToArray[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>, Int32)
       test      rax,rax
       je        near ptr M01_L45
       lea       r15,[rax+10]
       mov       r13d,[rax+8]
...
M01_L24:
       mov       rcx,240FAB445A8
       call      qword ptr [7FF982DB6658]; System.RuntimeType.InitializeCache()
       mov       r15,rax
...
M01_L25:
       ...
       jmp       near ptr M01_L16
M01_L26:
       call      qword ptr [7FF982F15BD8]; System.Buffer._BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
...
M01_L28:
       call      qword ptr [7FF98305E988]
       int       3
M01_L29:
       mov       rcx,rax
       mov       rdx,240FAB445D0
       mov       r8d,1
       call      qword ptr [7FF9830D41F8]; System.Attribute.GetCustomAttribute(System.Reflection.MemberInfo, System.Type, Boolean)
       mov       rdx,rax
...
M01_L41:
       ...
       lea       rcx,[rsp+48]
       mov       rdx,rax
       call      qword ptr [7FF9830AE4D8]; System.ModuleHandle.GetMetadataImport(System.Reflection.RuntimeModule)
       mov       rax,[rsp+28]
       mov       r8d,[rax+1C]
       lea       rdx,[rsp+38]
       lea       rcx,[rsp+48]
       call      qword ptr [7FF9830AF4B0]; System.Reflection.MetadataImport.GetName(Int32)
       lea       rcx,[rsp+38]
       call      qword ptr [7FF9830D5230]; System.MdUtf8String.ToString()
       mov       r8,rax
       mov       [rsp+20],r8
       mov       rcx,[rsp+28]
       lea       rcx,[rcx+20]
...
M01_L47:
       ...
       xor       edx,edx
       mov       r9d,2
       call      qword ptr [7FF9830D4E88]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].Populate(System.String, MemberListType, CacheType)
       mov       r12,rax
