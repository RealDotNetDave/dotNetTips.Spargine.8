...
; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetValues()
       ...
       xor       ecx,ecx
       xor       edx,edx
       call      qword ptr [7FF94D42C378]; DotNetTips.Spargine.Core.EnumHelper.GetValues[[System.Net.Cache.RequestCacheLevel, System.Net.Primitives]](Boolean, Boolean)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; DotNetTips.Spargine.Core.EnumHelper.GetValues[[System.Net.Cache.RequestCacheLevel, System.Net.Primitives]](Boolean, Boolean)
       ...
       je        near ptr M01_L38
       mov       rcx,2330A1F3B88
       call      qword ptr [7FF94CAD4990]; System.Enum.GetValuesAsUnderlyingTypeNoCopy(System.RuntimeType)
       mov       rdi,rax
       mov       r8d,[rdi+8]
       test      r8d,r8d
       jl        near ptr M01_L37
...
M01_L11:
       ...
       mov       rdx,2330A1F3BD8
       mov       r8d,1
       call      qword ptr [7FF94CDE4168]; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       test      rax,rax
       je        short M01_L12
...
M01_L17:
       ...
       call      qword ptr [7FF94D4C5080]; System.Collections.Immutable.ImmutableExtensions.ToArray[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>, Int32)
       test      rax,rax
       je        near ptr M01_L45
       lea       r15,[rax+10]
       mov       r13d,[rax+8]
...
M01_L30:
       call      qword ptr [7FF94CD7E988]
       int       3
M01_L31:
       mov       rcx,rax
       mov       rdx,2330A1F3BB0
       mov       r8d,1
       call      qword ptr [7FF94CDE41F8]; System.Attribute.GetCustomAttribute(System.Reflection.MemberInfo, System.Type, Boolean)
       mov       rdx,rax
...
M01_L42:
       ...
       lea       rcx,[rsp+48]
       mov       rdx,rax
       call      qword ptr [7FF94CDCE4D8]; System.ModuleHandle.GetMetadataImport(System.Reflection.RuntimeModule)
       mov       rax,[rsp+28]
       mov       r8d,[rax+1C]
       lea       rdx,[rsp+38]
       lea       rcx,[rsp+48]
       call      qword ptr [7FF94CDCF4B0]; System.Reflection.MetadataImport.GetName(Int32)
       lea       rcx,[rsp+38]
