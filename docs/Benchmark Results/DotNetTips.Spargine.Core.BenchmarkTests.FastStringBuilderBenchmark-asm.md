...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.FormatComparison()
       ...
       xor       edx,edx
       mov       r8,293C7D545A8
       call      qword ptr [7FFD31F4D830]; System.Text.StringBuilder.AppendFormatHelper(System.IFormatProvider, System.String, System.ReadOnlySpan`1<System.Object>)
       mov       [rsp+30],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+30]
       lea       rcx,[rbx+8]
...
M01_L00:
       ...
       call      qword ptr [7FFD31D843C0]; System.Runtime.CompilerServices.CastHelpers.ChkCastInterface(Void*, System.Object)
       mov       r15,rax
       xor       r13d,r13d
M01_L01:
       mov       r12d,[rsi+8]
       ...
       mov       rcx,[rsp+30]
       mov       r9d,eax
       call      qword ptr [7FFD3208D380]; System.PackedSpanHelpers.IndexOfAny[[System.SpanHelpers+DontNegate`1[[System.Int16, System.Private.CoreLib]], System.Private.CoreLib]](Int16 ByRef, Int16, Int16, Int32)
       mov       [rsp+8C],eax
       test      eax,eax
       jl        near ptr M01_L24
       cmp       eax,[rsp+70]
...
M01_L29:
       ...
       int       3
M01_L30:
       call      qword ptr [7FFD32085FB0]
       int       3
M01_L31:
       call      qword ptr [7FFD320857E8]
       int       3
M01_L32:
       call      qword ptr [7FFD32085F80]
       int       3
M01_L33:
       mov       ecx,2F1
       mov       rdx,7FFD31C34000
...
M00_L00:
       ...
       mov       rcx,rsi
       xor       r8d,r8d
       call      qword ptr [7FFD3201C0D8]; System.Text.StringBuilder..ctor(System.String, Int32, Int32, Int32)
       mov       ecx,[rsi+1C]
       add       ecx,[rsi+18]
       mov       [rsp+20],ecx
       mov       rcx,rsi
       ...
       mov       r8,24C82460008
       xor       r9d,r9d
       call      qword ptr [7FFD3201CA20]; System.Text.StringBuilder.Replace(System.String, System.String, Int32, Int32)
       mov       rcx,rax
       cmp       [rcx],ecx
...
M02_L05:
       ...
       mov       [rbp+1C],r10d
       mov       r9d,r10d
       call      qword ptr [7FFD31E351A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       mov       [rbp+34],eax
       test      eax,eax
       jl        near ptr M02_L19
       add       r12d,eax
...
M02_L07:
       lea       rcx,[rbp+38]
       mov       edx,r12d
       call      qword ptr [7FFD324ECFF0]; System.Collections.Generic.ValueListBuilder`1[[System.Int32, System.Private.CoreLib]].AddWithResize(Int32)
       jmp       short M02_L06
M02_L08:
       cmp       r12d,[r13+18]
       jge       short M02_L09
...
M02_L09:
       ...
       mov       r9d,eax
       mov       r8,r13
       call      qword ptr [7FFD3201CAC8]; System.Text.StringBuilder.ReplaceAllInChunk(System.ReadOnlySpan`1<Int32>, System.Text.StringBuilder, Int32, System.String)
       mov       ecx,[r14+8]
       sub       ecx,[rbp+1C]
       imul      ecx,[rbp+40]
       add       r12d,ecx
...
M02_L13:
       ...
       mov       rcx,[rcx]
       xor       r8d,r8d
       call      qword ptr [7FFD32507820]; Precode of System.Buffers.SharedArrayPool`1[[System.Int32, System.Private.CoreLib]].Return(Int32[], Boolean)
M02_L14:
       mov       rax,rdi
       mov       rcx,0A6ACCF6F902F
       cmp       [rbp+8],rcx
       je        short M02_L15
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Format()
       ...
       mov       rdx,[rbx+128]
       mov       rcx,1EA33A34558
       call      qword ptr [7FFD3265E550]; DotNetTips.Spargine.Core.FastStringBuilder.Format(System.String, System.String[])
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L02:
       ...
       mov       rcx,r14
       xor       edx,edx
       call      qword ptr [7FFD320B7078]; System.Text.StringBuilder.set_Length(Int32)
       mov       rdx,r14
       mov       [rbp-40],rdx
       jmp       short M01_L04
M01_L03:
...
M01_L10:
       ...
       mov       r8,rsi
       lea       r9,[rbp-38]
       call      qword ptr [7FFD320B77B0]; System.Text.StringBuilder.AppendFormatHelper(System.IFormatProvider, System.String, System.ReadOnlySpan`1<System.Object>)
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FFD320E3480]; System.Text.StringBuilder.ToString()
       mov       [rbp-48],rax
       mov       rcx,rsp
       call      M01_L16
       jmp       short M01_L15
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Remove()
       ...
       mov       rcx,[rbx+38]
       mov       rdx,1B81DC745A8
       call      qword ptr [7FFD3262E5B0]; DotNetTips.Spargine.Core.FastStringBuilder.Remove(System.String, System.String)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
