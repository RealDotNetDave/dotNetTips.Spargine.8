...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.FormatComparison()
       ...
       xor       edx,edx
       mov       r8,211F73745A8
       call      qword ptr [7FF9830DC930]; System.Text.StringBuilder.AppendFormatHelper(System.IFormatProvider, System.String, System.ReadOnlySpan`1<System.Object>)
       mov       [rsp+30],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+30]
       lea       rcx,[rbx+8]
...
M01_L00:
       ...
       call      qword ptr [7FF982E443C0]; System.Runtime.CompilerServices.CastHelpers.ChkCastInterface(Void*, System.Object)
       mov       r15,rax
       xor       r13d,r13d
M01_L01:
       mov       r12d,[rsi+8]
       ...
       mov       rcx,[rsp+30]
       mov       r9d,eax
       call      qword ptr [7FF9830F7C78]; System.PackedSpanHelpers.IndexOfAny[[System.SpanHelpers+DontNegate`1[[System.Int16, System.Private.CoreLib]], System.Private.CoreLib]](Int16 ByRef, Int16, Int16, Int32)
       mov       [rsp+8C],eax
       test      eax,eax
       jl        near ptr M01_L25
       cmp       eax,[rsp+70]
...
M01_L23:
       ...
       mov       rcx,rbx
       mov       rdx,r12
       call      qword ptr [7FF9830DC2A0]; System.Text.StringBuilder.Append(System.String)
       mov       eax,[rsp+94]
       mov       r8d,eax
       sub       r8d,[r12+8]
       mov       rcx,rbx
       mov       edx,20
       call      qword ptr [7FF9830DC258]
       jmp       near ptr M01_L01
M01_L24:
       sub       r8d,[r12+8]
       mov       rcx,rbx
...
M01_L30:
       ...
       int       3
M01_L31:
       call      qword ptr [7FF98303F198]
       int       3
M01_L32:
       call      qword ptr [7FF98303E9D0]
       int       3
M01_L33:
       call      qword ptr [7FF98303F168]
       int       3
M01_L34:
       mov       ecx,2F1
       mov       rdx,7FF982CF4000
...
M01_L36:
       mov       rcx,rbx
       mov       edx,eax
       call      qword ptr [7FF9830DC3D8]; System.Text.StringBuilder.Append(Char)
       inc       r13d
       jmp       near ptr M01_L01
M01_L37:
       lea       eax,[rax+rax*4]
...
M00_L00:
       ...
       mov       rcx,rsi
       xor       r8d,r8d
       call      qword ptr [7FF9830EC0D8]; System.Text.StringBuilder..ctor(System.String, Int32, Int32, Int32)
       mov       ecx,[rsi+1C]
       add       ecx,[rsi+18]
       mov       [rsp+20],ecx
       mov       rcx,rsi
       ...
       mov       r8,24E645D0008
       xor       r9d,r9d
       call      qword ptr [7FF9830ECA20]; System.Text.StringBuilder.Replace(System.String, System.String, Int32, Int32)
       mov       rcx,rax
       cmp       [rcx],ecx
...
M02_L05:
       ...
       mov       [rbp+1C],r10d
       mov       r9d,r10d
       call      qword ptr [7FF982F051A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       mov       [rbp+34],eax
       test      eax,eax
       jl        near ptr M02_L19
       add       r12d,eax
...
M02_L07:
       lea       rcx,[rbp+38]
       mov       edx,r12d
       call      qword ptr [7FF9835BCFF0]; System.Collections.Generic.ValueListBuilder`1[[System.Int32, System.Private.CoreLib]].AddWithResize(Int32)
       jmp       short M02_L06
M02_L08:
       cmp       r12d,[r13+18]
       jge       short M02_L09
...
M02_L09:
       ...
       mov       r9d,eax
       mov       r8,r13
       call      qword ptr [7FF9830ECAC8]; System.Text.StringBuilder.ReplaceAllInChunk(System.ReadOnlySpan`1<Int32>, System.Text.StringBuilder, Int32, System.String)
       mov       ecx,[r14+8]
       sub       ecx,[rbp+1C]
       imul      ecx,[rbp+40]
       add       r12d,ecx
...
M02_L13:
       ...
       mov       rcx,[rcx]
       xor       r8d,r8d
       call      qword ptr [7FF9835D7820]; Precode of System.Buffers.SharedArrayPool`1[[System.Int32, System.Private.CoreLib]].Return(Int32[], Boolean)
M02_L14:
       mov       rax,rdi
       mov       rcx,0CECCA31DDF27
       cmp       [rbp+8],rcx
       je        short M02_L15
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Format()
       ...
       mov       rdx,[rbx+128]
       mov       rcx,207669B45A8
       call      qword ptr [7FF98370E550]; DotNetTips.Spargine.Core.FastStringBuilder.Format(System.String, System.String[])
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L02:
       ...
       mov       rcx,r14
       xor       edx,edx
       call      qword ptr [7FF9830FC1F8]; System.Text.StringBuilder.set_Length(Int32)
       mov       rdx,r14
       mov       [rbp-40],rdx
       jmp       short M01_L04
M01_L03:
...
M01_L13:
       ...
       lea       rdx,[rbp-28]
       cmp       [rcx],ecx
       call      qword ptr [7FF9835CEBF8]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].TryDequeue(System.__Canon ByRef)
       test      eax,eax
       je        short M01_L14
       add       rdi,2C
...
M01_L19:
       ...
       mov       rdx,[rbp-40]
       cmp       [rcx],ecx
       call      qword ptr [7FF9835CEBC8]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].Enqueue(System.__Canon)
       jmp       short M01_L21
M01_L20:
       add       rbx,2C
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Remove()
       ...
       mov       rcx,[rbx+38]
       mov       rdx,27E411D45A8
       call      qword ptr [7FF98370E688]; DotNetTips.Spargine.Core.FastStringBuilder.Remove(System.String, System.String)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L02:
       ...
       lea       rdx,[rbp-40]
       cmp       [rcx],ecx
       call      qword ptr [7FF9835CEF88]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].TryDequeue(System.__Canon ByRef)
       test      eax,eax
       je        short M01_L03
       add       r15,2C
...
M01_L09:
       ...
       lea       r8,[rsi+0C]
       mov       r9d,r14d
       call      qword ptr [7FF982F151A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       test      eax,eax
       jge       short M01_L14
       jmp       short M01_L13
M01_L10:
...
M01_L32:
       ...
       mov       rdx,r13
       cmp       [rcx],ecx
       call      qword ptr [7FF9835CEF58]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].Enqueue(System.__Canon)
       jmp       short M01_L34
M01_L33:
       add       rsi,2C
