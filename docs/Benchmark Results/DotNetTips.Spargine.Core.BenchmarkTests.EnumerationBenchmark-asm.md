...
M01_L03:
       mov       rcx,rdx
       mov       rdx,7FFF7EC7AE80
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       jmp       short M01_L00
M01_L04:
       mov       rcx,rsi
       mov       rdx,7FFF7EB041E8
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       rcx,rax
       jmp       short M01_L01
M01_L05:
       mov       rcx,rsi
       mov       rdx,7FFF7EC7AE90
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       r11,rax
       jmp       short M01_L02
M01_L06:
...
M01_L11:
       ...
       jne       short M01_L15
       mov       rcx,r15
       call      qword ptr [7FFF7E6471F8]; System.Reflection.RtFieldInfo.InitializeInvocationFlags()
       mov       ecx,eax
       jmp       short M01_L16
M01_L12:
...
M01_L19:
       ...
       jne       short M01_L20
       mov       rcx,r15
       call      qword ptr [7FFF7E6473C0]; System.Reflection.RtFieldInfo.InitializeFieldType()
       mov       rdx,rax
M01_L20:
       mov       r12,rdx
       test      r12,r12
...
M01_L24:
       ...
       call      qword ptr [7FFF7E394360]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfClass(Void*, System.Object)
       test      rax,rax
       je        near ptr M01_L10
       mov       rdx,rax
       lea       rcx,[rbx+8]
...
M01_L29:
       ...
       call      qword ptr [7FFF7E604BD0]; System.RuntimeType+ListBuilder`1[[System.__Canon, System.Private.CoreLib]].Add(System.__Canon)
M01_L30:
       inc       r13d
       cmp       edi,r13d
       jg        short M01_L29
...
M01_L34:
       mov       r8d,r15d
       shl       r8,3
       call      qword ptr [7FFF7E445BC0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       mov       rdx,rdi
       jmp       short M01_L32
M01_L35:
...
M01_L40:
       ...
       xor       edx,edx
       mov       r9d,2
       call      qword ptr [7FFF7E604E88]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].Populate(System.String, MemberListType, CacheType)
       mov       r14,rax
...
M01_L88:
       ...
       mov       rcx,r15
       cmp       [rcx],ecx
       call      qword ptr [7FFF7E6164A0]; System.Reflection.RuntimeFieldInfo.get_DeclaringType()
       mov       rcx,rax
       mov       rax,[rax]
       mov       rax,[rax+0B0]
       call      qword ptr [rax]
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFF7E8DD500]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFF7E5B6718]
       mov       rcx,rbx
...
M01_L90:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFF7E8F5998]
       mov       rdx,rax
       mov       rcx,rbx
       xor       r8d,r8d
       call      qword ptr [7FFF7E60DB60]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
M01_L91:
       call      qword ptr [7FFF7E3943F0]; System.Runtime.CompilerServices.CastHelpers.ChkCastClassSpecial(Void*, System.Object)
       int       3
M01_L92:
       mov       rdx,rax
       call      qword ptr [7FFF7E44E130]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].AddWithResize(System.__Canon)
