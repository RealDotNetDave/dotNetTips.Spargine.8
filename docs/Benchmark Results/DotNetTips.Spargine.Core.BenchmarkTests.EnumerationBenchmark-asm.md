...
M01_L03:
       mov       rcx,rdx
       mov       rdx,7FFD3268AD48
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       jmp       short M01_L00
M01_L04:
       mov       rcx,rsi
       mov       rdx,7FFD32525A70
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       rcx,rax
       jmp       short M01_L01
M01_L05:
       mov       rcx,rsi
       mov       rdx,7FFD3268AD58
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       r11,rax
       jmp       short M01_L02
M01_L06:
...
M01_L11:
       ...
       jne       short M01_L15
       mov       rcx,r12
       call      qword ptr [7FFD31F9C8D0]; System.Reflection.RtFieldInfo.InitializeInvocationFlags()
       mov       ecx,eax
       jmp       short M01_L16
M01_L12:
...
M01_L19:
       ...
       jne       short M01_L20
       mov       rcx,r12
       call      qword ptr [7FFD31F9CA98]; System.Reflection.RtFieldInfo.InitializeFieldType()
       mov       rdx,rax
M01_L20:
       mov       rdi,rdx
       test      rdi,rdi
...
M01_L34:
       mov       r8d,r12d
       shl       r8,3
       call      qword ptr [7FFD31E55BC0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       mov       rdx,r14
       jmp       short M01_L32
M01_L35:
       mov       rcx,27F066645A8
...
M01_L89:
       ...
       mov       rcx,r12
       cmp       [rcx],ecx
       call      qword ptr [7FFD31F80EA0]; Precode of System.Reflection.RuntimeFieldInfo.get_DeclaringType()
       mov       rcx,rax
       mov       rax,[rax]
       mov       rax,[rax+0B0]
       call      qword ptr [rax]
...
M01_L91:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFD323149A8]
       mov       rdx,rax
       mov       rcx,rbx
       xor       r8d,r8d
       call      qword ptr [7FFD31F4E508]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
M01_L92:
