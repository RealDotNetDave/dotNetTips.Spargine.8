...
M01_L03:
       mov       rcx,rdx
       mov       rdx,7FF9B371DCE0
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       jmp       short M01_L00
M01_L04:
       mov       rcx,rsi
       mov       rdx,7FF9B35B6598
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       rcx,rax
       jmp       short M01_L01
M01_L05:
       mov       rcx,rsi
       mov       rdx,7FF9B371DCF0
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       r11,rax
       jmp       short M01_L02
M01_L06:
...
M01_L11:
       ...
       jne       short M01_L15
       mov       rcx,r12
       call      qword ptr [7FF9B303C8D0]; System.Reflection.RtFieldInfo.InitializeInvocationFlags()
       mov       ecx,eax
       jmp       short M01_L16
M01_L12:
...
M01_L19:
       ...
       jne       short M01_L20
       mov       rcx,r12
       call      qword ptr [7FF9B303CA98]; System.Reflection.RtFieldInfo.InitializeFieldType()
       mov       rdx,rax
M01_L20:
       mov       rdi,rdx
       test      rdi,rdi
...
M01_L34:
       mov       r8d,r12d
       shl       r8,3
       call      qword ptr [7FF9B2EF5BC0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       mov       rdx,r14
       jmp       short M01_L32
M01_L35:
       mov       rcx,2780AD84768
...
M01_L89:
       ...
       mov       rcx,r12
       cmp       [rcx],ecx
       call      qword ptr [7FF9B3010EA0]; Precode of System.Reflection.RuntimeFieldInfo.get_DeclaringType()
       mov       rcx,rax
       mov       rax,[rax]
       mov       rax,[rax+0B0]
       call      qword ptr [rax]
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF9B338C510]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF9B2FE5F68]
       mov       rcx,rbx
...
M01_L91:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF9B33A49A8]
       mov       rdx,rax
       mov       rcx,rbx
       xor       r8d,r8d
       call      qword ptr [7FF9B2FEE508]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
M01_L92:
