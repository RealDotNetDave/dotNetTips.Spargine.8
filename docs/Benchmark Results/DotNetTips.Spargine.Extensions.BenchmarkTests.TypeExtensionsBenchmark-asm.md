...
; DotNetTips.Spargine.Extensions.BenchmarkTests.TypeExtensionsBenchmark.GetTypeOfType()
       ...
       mov       rcx,28555192290
       cmp       [rcx],ecx
       call      qword ptr [7FF8FFF6A5D8]; System.RuntimeType.IsValueTypeImpl()
       test      eax,eax
       ...
       mov       r8d,0FFFFFFFF
       mov       r9d,1C
       call      qword ptr [7FF8FFF76838]; System.RuntimeType.GetMethodImplCommon(System.String, Int32, System.Reflection.BindingFlags, System.Reflection.Binder, System.Reflection.CallingConventions, System.Type[], System.Reflection.ParameterModifier[])
       test      rax,rax
       je        short M00_L03
       mov       rcx,rax
       mov       rdx,2855519E328
       mov       r8d,1
       call      qword ptr [7FF90022E9D0]; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       test      rax,rax
       je        short M00_L00
...
M00_L04:
       ...
       cmp       [rcx],cl
       lea       rcx,[rbp-10]
       call      qword ptr [7FF90093E688]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[DotNetTips.Spargine.Extensions.TypeOfType, DotNetTips.Spargine.8.Extensions]](DotNetTips.Spargine.Extensions.TypeOfType ByRef)
       nop
       add       rsp,48
       pop       rbx
       pop       rbp
...
M01_L00:
       mov       rdx,28555195358
       call      qword ptr [7FF8FFF6A7A8]; System.RuntimeType.IsSubclassOf(System.Type)
       nop
       add       rsp,28
       ret
...
M02_L02:
       ...
       lea       rcx,[rdi+20]
       mov       r8,r15
       mov       rdx,offset MT_System.Reflection.CerHashtable<System.String, System.Reflection.RuntimeMethodInfo[]>
       call      qword ptr [7FF900226868]; System.Reflection.CerHashtable`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].get_Item(System.__Canon)
       test      rax,rax
       je        near ptr M02_L14
M02_L03:
       mov       r13,rax
...
M02_L06:
       ...
       mov       r8d,esi
       mov       r9d,r14d
       call      qword ptr [7FF8FFF765B0]; System.RuntimeType.FilterApplyMethodBase(System.Reflection.MethodBase, System.Reflection.BindingFlags, System.Reflection.BindingFlags, System.Reflection.CallingConventions, System.Type[])
       test      eax,eax
       je        short M02_L07
       lea       rcx,[rsp+38]
       mov       r8,r12
       mov       rdx,offset MT_System.RuntimeType+ListBuilder<System.Reflection.MethodInfo>
       call      qword ptr [7FF90022F438]; System.RuntimeType+ListBuilder`1[[System.__Canon, System.Private.CoreLib]].Add(System.__Canon)
M02_L07:
       inc       r15d
       cmp       edi,r15d
       jg        short M02_L05
...
M02_L14:
       ...
       mov       r8d,1
       xor       r9d,r9d
       call      qword ptr [7FF90022F6F0]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].Populate(System.String, MemberListType, CacheType)
...
M02_L24:
       mov       rdx,rdi
       call      qword ptr [7FF9006DDE90]
       test      eax,eax
       jne       short M02_L25
       mov       rcx,rdi
       call      qword ptr [7FF900395FC8]
       mov       rcx,rax
       call      CORINFO_HELP_THROW
M02_L25:
       inc       esi
M02_L26:
       ...
       lea       rcx,[rsp+50]
       mov       rdx,offset MT_System.RuntimeType+ListBuilder<System.Reflection.MethodInfo>
       call      qword ptr [7FF90022F3F0]; System.RuntimeType+ListBuilder`1[[System.__Canon, System.Private.CoreLib]].ToArray()
       mov       rcx,rax
       mov       edx,[rsp+60]
       call      qword ptr [7FF9006DDEC0]
       mov       rdx,rax
...
M02_L27:
       ...
       test      rbx,rbx
       jne       short M02_L28
       call      qword ptr [7FF8FFF75FC8]; System.Type.get_DefaultBinder()
       mov       rbx,rax
M02_L28:
       lea       rcx,[rsp+50]
       mov       rdx,offset MT_System.RuntimeType+ListBuilder<System.Reflection.MethodInfo>
...
; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       ...
       mov       rbp,285551920B0
       mov       rcx,rbx
       call      qword ptr [7FF8FFF77330]; System.RuntimeType.GetBaseType()
       test      rax,rax
       je        near ptr M03_L12
M03_L00:
       cmp       rax,rbp
...
M03_L03:
       ...
       movzx     r8d,dil
       mov       rcx,rsi
       call      qword ptr [7FF900244E58]; System.Reflection.CustomAttribute.GetCustomAttributes(System.Reflection.RuntimeMethodInfo, System.RuntimeType, Boolean)
M03_L04:
       mov       r8,rax
       test      r8,r8
       je        short M03_L05
...
M03_L08:
       movzx     r8d,dil
       mov       rdx,rbx
       call      qword ptr [7FF90022E868]; System.Attribute.InternalGetCustomAttributes(System.Reflection.PropertyInfo, System.Type, Boolean)
       jmp       short M03_L06
M03_L09:
       mov       rcx,rdx
       mov       rdx,rsi
