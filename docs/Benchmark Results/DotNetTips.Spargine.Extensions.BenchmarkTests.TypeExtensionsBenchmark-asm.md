...
; DotNetTips.Spargine.Extensions.BenchmarkTests.TypeExtensionsBenchmark.GetTypeOfType()
       ...
       mov       rcx,2A4880D2290
       cmp       [rcx],ecx
       call      qword ptr [7FFA34E5A5D8]; System.RuntimeType.IsValueTypeImpl()
       test      eax,eax
       ...
       mov       r8d,0FFFFFFFF
       mov       r9d,1C
       call      qword ptr [7FFA34E66838]; System.RuntimeType.GetMethodImplCommon(System.String, Int32, System.Reflection.BindingFlags, System.Reflection.Binder, System.Reflection.CallingConventions, System.Type[], System.Reflection.ParameterModifier[])
       test      rax,rax
       je        short M00_L03
       mov       rcx,rax
       mov       rdx,2A4880DE128
       mov       r8d,1
       call      qword ptr [7FFA3510E9D0]; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       test      rax,rax
       je        short M00_L00
...
M00_L04:
       ...
       cmp       [rcx],cl
       lea       rcx,[rbp-10]
       call      qword ptr [7FFA3583C048]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[DotNetTips.Spargine.Extensions.TypeOfType, DotNetTips.Spargine.8.Extensions]](DotNetTips.Spargine.Extensions.TypeOfType ByRef)
       nop
       add       rsp,48
       pop       rbx
       pop       rbp
...
M01_L00:
       mov       rdx,2A4880D5358
       call      qword ptr [7FFA34E5A7A8]; System.RuntimeType.IsSubclassOf(System.Type)
       nop
       add       rsp,28
       ret
...
M02_L02:
       ...
       call      qword ptr [7FFA35106868]; System.Reflection.CerHashtable`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].get_Item(System.__Canon)
       test      rax,rax
       je        near ptr M02_L14
M02_L03:
       mov       r13,rax
...
M02_L06:
       ...
       mov       r8d,esi
       mov       r9d,r14d
       call      qword ptr [7FFA34E665B0]; System.RuntimeType.FilterApplyMethodBase(System.Reflection.MethodBase, System.Reflection.BindingFlags, System.Reflection.BindingFlags, System.Reflection.CallingConventions, System.Type[])
       test      eax,eax
       je        short M02_L07
       lea       rcx,[rsp+38]
       mov       r8,r12
       mov       rdx,offset MT_System.RuntimeType+ListBuilder`1[[System.Reflection.MethodInfo, System.Private.CoreLib]]
       call      qword ptr [7FFA3510F438]; System.RuntimeType+ListBuilder`1[[System.__Canon, System.Private.CoreLib]].Add(System.__Canon)
M02_L07:
       inc       r15d
       cmp       edi,r15d
       jg        short M02_L05
...
M02_L12:
       ...
       mov       rcx,[rcx]
       mov       rdx,r15
       call      qword ptr [7FFA351BEFB8]
       mov       r15,rax
       mov       r13d,2
       jmp       near ptr M02_L00
M02_L13:
       mov       rcx,rdi
       call      qword ptr [7FFA34E66658]; System.RuntimeType.InitializeCache()
       mov       r12,rax
...
M02_L14:
       ...
       mov       r8d,1
       xor       r9d,r9d
       call      qword ptr [7FFA3510F6F0]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].Populate(System.String, MemberListType, CacheType)
...
; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       ...
       mov       rbp,2A4880D20B0
       mov       rcx,rbx
       call      qword ptr [7FFA34E67330]; System.RuntimeType.GetBaseType()
       test      rax,rax
       je        near ptr M03_L12
M03_L00:
       cmp       rax,rbp
...
M03_L03:
       ...
       movzx     r8d,dil
       mov       rcx,rsi
       call      qword ptr [7FFA35134E58]; System.Reflection.CustomAttribute.GetCustomAttributes(System.Reflection.RuntimeMethodInfo, System.RuntimeType, Boolean)
M03_L04:
       mov       r8,rax
       test      r8,r8
       je        short M03_L05
       ...
       je        short M03_L05
       mov       rdx,rax
       call      qword ptr [7FFA34F14390]; System.Runtime.CompilerServices.CastHelpers.ChkCastAny(Void*, System.Object)
       mov       r8,rax
M03_L05:
       mov       rax,r8
M03_L06:
...
M03_L08:
       movzx     r8d,dil
       mov       rdx,rbx
       call      qword ptr [7FFA3510E868]; System.Attribute.InternalGetCustomAttributes(System.Reflection.PropertyInfo, System.Type, Boolean)
       jmp       short M03_L06
M03_L09:
       mov       rcx,rdx
       mov       rdx,rsi
...
M03_L10:
       ...
       call      qword ptr [7FFA34F143D8]; System.Runtime.CompilerServices.CastHelpers.ChkCastClass(Void*, System.Object)
       mov       rcx,rax
       movzx     r8d,dil
       mov       rdx,rbx
       call      qword ptr [7FFA3510E8B0]
       jmp       short M03_L06
M03_L11:
       mov       ecx,0D9
