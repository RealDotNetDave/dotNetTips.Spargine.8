...
; DotNetTips.Spargine.Extensions.BenchmarkTests.TypeExtensionsBenchmark.GetTypeOfType()
       ...
       mov       rcx,2A33C252290
       cmp       [rcx],ecx
       call      qword ptr [7FFF5403A5D8]; System.RuntimeType.IsValueTypeImpl()
       test      eax,eax
       ...
       mov       r8d,0FFFFFFFF
       mov       r9d,1C
       call      qword ptr [7FFF54046838]; System.RuntimeType.GetMethodImplCommon(System.String, Int32, System.Reflection.BindingFlags, System.Reflection.Binder, System.Reflection.CallingConventions, System.Type[], System.Reflection.ParameterModifier[])
       test      rax,rax
       je        short M00_L03
       mov       rcx,rax
       mov       rdx,2A33C25E128
       mov       r8d,1
       call      qword ptr [7FFF542EE9D0]; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       test      rax,rax
       je        short M00_L00
...
M00_L04:
       ...
       cmp       [rcx],cl
       lea       rcx,[rbp-10]
       call      qword ptr [7FFF54A17D38]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[DotNetTips.Spargine.Extensions.TypeOfType, DotNetTips.Spargine.8.Extensions]](DotNetTips.Spargine.Extensions.TypeOfType ByRef)
       nop
       add       rsp,48
       pop       rbx
       pop       rbp
...
M01_L00:
       mov       rdx,2A33C255358
       call      qword ptr [7FFF5403A7A8]; System.RuntimeType.IsSubclassOf(System.Type)
       nop
       add       rsp,28
       ret
...
M02_L02:
       ...
       call      qword ptr [7FFF542E6868]; System.Reflection.CerHashtable`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].get_Item(System.__Canon)
       test      rax,rax
       je        near ptr M02_L14
M02_L03:
       mov       r13,rax
...
M02_L06:
       ...
       mov       r8d,esi
       mov       r9d,r14d
       call      qword ptr [7FFF540465B0]; System.RuntimeType.FilterApplyMethodBase(System.Reflection.MethodBase, System.Reflection.BindingFlags, System.Reflection.BindingFlags, System.Reflection.CallingConventions, System.Type[])
       test      eax,eax
       je        short M02_L07
       lea       rcx,[rsp+38]
       mov       r8,r12
...
; System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo, System.Type, Boolean)
       ...
       mov       rbp,2A33C2520B0
       mov       rcx,rbx
       call      qword ptr [7FFF54047330]; System.RuntimeType.GetBaseType()
       test      rax,rax
       je        near ptr M03_L12
M03_L00:
       cmp       rax,rbp
...
M03_L03:
       ...
       movzx     r8d,dil
       mov       rcx,rsi
       call      qword ptr [7FFF54314E58]; System.Reflection.CustomAttribute.GetCustomAttributes(System.Reflection.RuntimeMethodInfo, System.RuntimeType, Boolean)
M03_L04:
       mov       r8,rax
       test      r8,r8
       je        short M03_L05
...
M03_L08:
       movzx     r8d,dil
       mov       rdx,rbx
       call      qword ptr [7FFF542EE868]; System.Attribute.InternalGetCustomAttributes(System.Reflection.PropertyInfo, System.Type, Boolean)
       jmp       short M03_L06
M03_L09:
       mov       rcx,rdx
       mov       rdx,rsi
