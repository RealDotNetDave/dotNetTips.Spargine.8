...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetAllInterfaces01()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFC1FF8C078]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rcx,rax
       call      qword ptr [7FFC2056F378]; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllInterfaces(System.Reflection.Assembly)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; System.Reflection.Assembly.GetExecutingAssembly()
       ...
       lea       rcx,[rsp+20]
       call      qword ptr [7FFC1FF8C060]; System.Reflection.Assembly.GetExecutingAssembly(System.Threading.StackCrawlMark ByRef)
       nop
       add       rsp,28
       ret
...
; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllInterfaces(System.Reflection.Assembly)
       ...
       mov       rcx,rbx
       call      qword ptr [7FFC1FFA3670]; System.Reflection.Assembly.GetTypes()
       mov       rdi,rax
M02_L00:
       xor       ebp,ebp
       mov       r14d,[rdi+8]
...
M02_L03:
       ...
       mov       r9d,5
       cmp       [rcx],ecx
       call      qword ptr [7FFC20085038]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].GetMemberList(MemberListType, System.String, CacheType)
       test      rax,rax
       je        near ptr M02_L08
       lea       rbx,[rax+10]
       mov       r15d,[rax+8]
...
M02_L06:
       mov       rcx,rsi
       call      qword ptr [7FFC1FE8E160]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].AddRange(System.Collections.Generic.IEnumerable`1<System.__Canon>)
       inc       ebp
       cmp       r14d,ebp
       jg        near ptr M02_L01
M02_L07:
...
M02_L09:
       ...
       jmp       short M02_L06
M02_L10:
       call      qword ptr [7FFC1FD26658]; System.RuntimeType.InitializeCache()
       mov       rbx,rax
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetAllTypes01()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFC1FF5C078]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rcx,rax
       call      qword ptr [7FFC20545EF0]; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllTypes(System.Reflection.Assembly)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; System.Reflection.Assembly.GetExecutingAssembly()
       ...
       mov       dword ptr [rsp+20],1
       lea       rcx,[rsp+20]
       call      qword ptr [7FFC1FF5C060]; System.Reflection.Assembly.GetExecutingAssembly(System.Threading.StackCrawlMark ByRef)
       nop
       add       rsp,28
       ret
; Total bytes of code 29
...
; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllTypes(System.Reflection.Assembly)
       ...
       call      qword ptr [7FFC1FF73670]; System.Reflection.Assembly.GetTypes()
       mov       rbx,rax
M02_L00:
       mov       rdx,219A3C0BC18
       mov       rsi,[rdx]
...
M02_L01:
       ...
       call      qword ptr [7FFC1FDA4360]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfClass(Void*, System.Object)
       test      rax,rax
       jne       near ptr M02_L12
       mov       rdx,rbx
       mov       rcx,offset MT_System.Type[]
       call      qword ptr [7FFC1FDA4330]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfAny(Void*, System.Object)
       mov       rdi,rax
       test      rdi,rdi
       je        near ptr M02_L14
...
M02_L07:
       ...
       mov       edx,1
       xor       r8d,r8d
       call      qword ptr [7FFC202B7A68]
       mov       rbx,rax
       mov       rcx,offset MT_System.ArgumentNullException
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FFC202BC060]
       mov       rdx,rax
       mov       rcx,rbp
       call      qword ptr [7FFC202BC5E8]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
...
M02_L17:
       ...
       mov       rcx,rsi
       mov       rdx,rbp
       call      qword ptr [7FFC1FE5DFC8]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]]..ctor(System.Collections.Generic.IEnumerable`1<System.__Canon>)
       jmp       near ptr M02_L04
