## DotNetTips.Spargine.Tester.BenchmarkTests.RandomDataCollectionsBenchmark-20250415-062609
...
+       call      qword ptr [7FFE9878DFF8]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].set_Capacity(Int32)
        ...
        ret
```
**Diff for GenerateCreditCards method between:**
.NET 8.0.15 (8.0.1525.16413), X64 RyuJIT AVX2
.NET 8.0.15 (8.0.1525.16413), X64 RyuJIT AVX2
```diff
test      edx,edx
...
+       call      qword ptr [7FFE98E047C8]
 ...
 M01_L17:
```
**Diff for GeneratePersonNames method between:**
.NET 8.0.15 (8.0.1525.16413), X64 RyuJIT AVX2
.NET 8.0.15 (8.0.1525.16413), X64 RyuJIT AVX2
```diff
test      eax,eax
