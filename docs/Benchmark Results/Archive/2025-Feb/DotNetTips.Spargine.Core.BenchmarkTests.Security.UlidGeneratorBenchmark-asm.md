...
; DotNetTips.Spargine.Core.BenchmarkTests.Security.UlidGeneratorBenchmark.GenerateKey()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFE5CC963A0]; DotNetTips.Spargine.Core.KeyGenerator.GenerateKey()
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; DotNetTips.Spargine.Core.BenchmarkTests.Security.UlidGeneratorBenchmark.GenerateMultipleUlids()
       ...
       mov       rbx,rcx
       mov       ecx,100
       call      qword ptr [7FFE5CD77AE0]; DotNetTips.Spargine.Core.Security.UlidGenerator.GenerateMultipleUlids(Int32)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L02:
       ...
       jle       short M01_L05
M01_L03:
       call      qword ptr [7FFE5CD77AF8]; DotNetTips.Spargine.Core.Security.UlidGenerator.GenerateUlid()
...
M01_L08:
       call      qword ptr [7FFE5C97FB40]
       mov       rdi,rax
       test      rdi,rdi
       jne       short M01_L09
       call      qword ptr [7FFE5C97F960]
       mov       rdi,rax
M01_L09:
...
M00_L01:
       ...
       mov       r9,7FFE5C39D370
       call      qword ptr [7FFE5C4E4258]; System.MulticastDelegate.CtorOpened(System.Object, IntPtr, IntPtr)
       mov       rcx,23F03C081D8
       mov       rdx,rsi
       call      CORINFO_HELP_ASSIGN_REF
       mov       rax,rsi
...
; DotNetTips.Spargine.Core.BenchmarkTests.Security.UlidGeneratorBenchmark.GuidNewGuid()
       ...
       cmp       [rcx],cl
       lea       rcx,[rsp+20]
       call      qword ptr [7FFE5CD77AE0]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[System.Guid, System.Private.CoreLib]](System.Guid ByRef)
       nop
       add       rsp,40
       pop       rbx
       ret
