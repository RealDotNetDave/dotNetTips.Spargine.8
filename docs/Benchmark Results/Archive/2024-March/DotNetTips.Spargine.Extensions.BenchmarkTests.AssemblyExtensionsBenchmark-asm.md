...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetAllInterfaces01()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFF8268C078]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rcx,rax
       call      qword ptr [7FFF82C6F6A8]; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllInterfaces(System.Reflection.Assembly)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; System.Reflection.Assembly.GetExecutingAssembly()
       ...
       lea       rcx,[rsp+20]
       call      qword ptr [7FFF8268C060]; System.Reflection.Assembly.GetExecutingAssembly(System.Threading.StackCrawlMark ByRef)
       nop
       add       rsp,28
       ret
...
; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllInterfaces(System.Reflection.Assembly)
       ...
       mov       rcx,rbx
       call      qword ptr [7FFF826A3670]; System.Reflection.Assembly.GetTypes()
       mov       rdi,rax
M02_L00:
       xor       ebp,ebp
       mov       r14d,[rdi+8]
...
M02_L03:
       ...
       mov       r9d,5
       cmp       [rcx],ecx
       call      qword ptr [7FFF82785038]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].GetMemberList(MemberListType, System.String, CacheType)
       test      rax,rax
       je        near ptr M02_L08
       lea       rbx,[rax+10]
       mov       r15d,[rax+8]
...
M02_L06:
       mov       rcx,rsi
       call      qword ptr [7FFF8258E160]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].AddRange(System.Collections.Generic.IEnumerable`1<System.__Canon>)
       inc       ebp
       cmp       r14d,ebp
       jg        near ptr M02_L01
M02_L07:
...
M02_L09:
       ...
       jmp       short M02_L06
M02_L10:
       call      qword ptr [7FFF82426658]; System.RuntimeType.InitializeCache()
       mov       rbx,rax
...
M02_L12:
       call      qword ptr [7FFF82585BD8]; System.Buffer._BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetAllTypes01()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFF8269C078]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rcx,rax
       call      qword ptr [7FFF82C85F98]; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllTypes(System.Reflection.Assembly)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; System.Reflection.Assembly.GetExecutingAssembly()
       ...
       mov       dword ptr [rsp+20],1
       lea       rcx,[rsp+20]
       call      qword ptr [7FFF8269C060]; System.Reflection.Assembly.GetExecutingAssembly(System.Threading.StackCrawlMark ByRef)
       nop
       add       rsp,28
       ret
; Total bytes of code 29
...
; DotNetTips.Spargine.Extensions.AssemblyExtensions.GetAllTypes(System.Reflection.Assembly)
       ...
       call      qword ptr [7FFF826B3670]; System.Reflection.Assembly.GetTypes()
       mov       rbx,rax
M02_L00:
       mov       rdx,14C3E40BCD8
       mov       rsi,[rdx]
...
M02_L01:
       ...
       mov       rdx,rbx
       mov       rcx,offset MT_System.Type[]
       call      qword ptr [7FFF824E4330]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfAny(Void*, System.Object)
       mov       rdi,rax
       test      rdi,rdi
       je        near ptr M02_L14
...
M02_L17:
       ...
       mov       rcx,rsi
       mov       rdx,rbp
       call      qword ptr [7FFF8259DFC8]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]]..ctor(System.Collections.Generic.IEnumerable`1<System.__Canon>)
       jmp       near ptr M02_L04
