...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.FormatComparison()
       ...
       xor       edx,edx
       mov       r8,22A18E64768
       call      qword ptr [7FF9B302D830]; System.Text.StringBuilder.AppendFormatHelper(System.IFormatProvider, System.String, System.ReadOnlySpan`1<System.Object>)
       mov       [rsp+30],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+30]
       lea       rcx,[rbx+8]
...
M01_L00:
       ...
       call      qword ptr [7FF9B2E643C0]; System.Runtime.CompilerServices.CastHelpers.ChkCastInterface(Void*, System.Object)
       mov       r15,rax
       xor       r13d,r13d
M01_L01:
       mov       r12d,[rsi+8]
       ...
       mov       rcx,[rsp+30]
       mov       r9d,eax
       call      qword ptr [7FF9B315D380]; System.PackedSpanHelpers.IndexOfAny[[System.SpanHelpers+DontNegate`1[[System.Int16, System.Private.CoreLib]], System.Private.CoreLib]](Int16 ByRef, Int16, Int16, Int32)
       mov       [rsp+9C],eax
       test      eax,eax
       jl        near ptr M01_L23
       cmp       eax,[rsp+78]
...
M01_L28:
       ...
       int       3
M01_L29:
       call      qword ptr [7FF9B3155FB0]
       int       3
M01_L30:
       call      qword ptr [7FF9B31557E8]
       int       3
M01_L31:
       call      qword ptr [7FF9B3155F80]
       int       3
M01_L32:
       mov       ecx,2F1
       mov       rdx,7FF9B2D14000
...
M00_L00:
       ...
       mov       rcx,rsi
       xor       r8d,r8d
       call      qword ptr [7FF9B301CFD8]; System.Text.StringBuilder..ctor(System.String, Int32, Int32, Int32)
       mov       ecx,[rsi+1C]
       add       ecx,[rsi+18]
       mov       [rsp+20],ecx
       mov       rcx,rsi
       ...
       mov       r8,2292EE60008
       xor       r9d,r9d
       call      qword ptr [7FF9B301D920]; System.Text.StringBuilder.Replace(System.String, System.String, Int32, Int32)
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FF9B30296D0]; System.Text.StringBuilder.ToString()
       mov       [rsp+30],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+30]
       lea       rcx,[rbx+8]
...
M02_L05:
       ...
       mov       [rbp+1C],r10d
       mov       r9d,r10d
       call      qword ptr [7FF9B2F051A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       mov       [rbp+34],eax
       test      eax,eax
       jl        near ptr M02_L19
       add       r12d,eax
...
M02_L07:
       lea       rcx,[rbp+38]
       mov       edx,r12d
       call      qword ptr [7FF9B35C7210]; System.Collections.Generic.ValueListBuilder`1[[System.Int32, System.Private.CoreLib]].AddWithResize(Int32)
       jmp       short M02_L06
M02_L08:
       cmp       r12d,[r13+18]
       jge       short M02_L09
...
M02_L09:
       ...
       mov       r9d,eax
       mov       r8,r13
       call      qword ptr [7FF9B301D9C8]; System.Text.StringBuilder.ReplaceAllInChunk(System.ReadOnlySpan`1<Int32>, System.Text.StringBuilder, Int32, System.String)
       mov       ecx,[r14+8]
       sub       ecx,[rbp+1C]
       imul      ecx,[rbp+40]
       add       r12d,ecx
...
M02_L13:
       ...
       mov       rcx,[rcx]
       xor       r8d,r8d
       call      qword ptr [7FF9B35E7820]; Precode of System.Buffers.SharedArrayPool`1[[System.Int32, System.Private.CoreLib]].Return(Int32[], Boolean)
M02_L14:
       mov       rax,rdi
       mov       rcx,0CA355835DF6E
       cmp       [rbp+8],rcx
       je        short M02_L15
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Format()
       ...
       mov       rdx,[rbx+128]
       mov       rcx,273CBAE4768
       call      qword ptr [7FF9B370E4C0]; DotNetTips.Spargine.Core.FastStringBuilder.Format(System.String, System.String[])
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L10:
       ...
       mov       r8,rsi
       lea       r9,[rbp-38]
       call      qword ptr [7FF9B30EC930]; System.Text.StringBuilder.AppendFormatHelper(System.IFormatProvider, System.String, System.ReadOnlySpan`1<System.Object>)
       mov       rcx,rax
       cmp       [rcx],ecx
...
M01_L13:
       ...
       lea       rdx,[rbp-28]
       cmp       [rcx],ecx
       call      qword ptr [7FF9B35CD4B8]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].TryDequeue(System.__Canon ByRef)
       test      eax,eax
       je        short M01_L14
       add       rdi,2C
...
M01_L19:
       ...
       mov       rdx,[rbp-40]
       cmp       [rcx],ecx
       call      qword ptr [7FF9B35CD488]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].Enqueue(System.__Canon)
       jmp       short M01_L21
M01_L20:
       add       rbx,2C
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Remove()
       ...
       mov       rcx,[rbx+38]
       mov       rdx,267DF744768
       call      qword ptr [7FF9B37245A0]; DotNetTips.Spargine.Core.FastStringBuilder.Remove(System.String, System.String)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L09:
       ...
       lea       r8,[rsi+0C]
       mov       r9d,r14d
       call      qword ptr [7FF9B2EF51A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       test      eax,eax
       jge       short M01_L14
       jmp       short M01_L13
M01_L10:
