...
M01_L03:
       mov       rcx,rdx
       mov       rdx,7FFBD4E8A978
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       jmp       short M01_L00
M01_L04:
       mov       rcx,rdx
       mov       rdx,7FFBD4D221B0
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       jmp       short M01_L01
M01_L05:
       mov       rcx,rdx
       mov       rdx,7FFBD4E8A988
       call      CORINFO_HELP_RUNTIMEHANDLE_CLASS
       mov       r11,rax
       jmp       short M01_L02
M01_L06:
...
M01_L11:
       ...
       jne       short M01_L15
       mov       rcx,r12
       call      qword ptr [7FFBD479C8D0]; System.Reflection.RtFieldInfo.InitializeInvocationFlags()
       mov       ecx,eax
       jmp       short M01_L16
M01_L12:
...
M01_L19:
       ...
       jne       short M01_L20
       mov       rcx,r12
       call      qword ptr [7FFBD479CA98]; System.Reflection.RtFieldInfo.InitializeFieldType()
       mov       rdx,rax
M01_L20:
       mov       r13,rdx
       test      r13,r13
...
M01_L29:
       ...
       call      qword ptr [7FFBD472F438]; System.RuntimeType+ListBuilder`1[[System.__Canon, System.Private.CoreLib]].Add(System.__Canon)
M01_L30:
       inc       esi
       cmp       [rdi+8],esi
       jg        short M01_L29
...
M01_L34:
       mov       rcx,22168CC45A8
       call      qword ptr [7FFBD44F6658]; System.RuntimeType.InitializeCache()
       mov       rdi,rax
...
M01_L36:
       ...
       xor       edx,edx
       mov       r9d,2
       call      qword ptr [7FFBD472F6F0]; System.RuntimeType+RuntimeTypeCache+MemberInfoCache`1[[System.__Canon, System.Private.CoreLib]].Populate(System.String, MemberListType, CacheType)
       mov       rdi,rax
...
M01_L41:
       mov       r8d,r12d
       shl       r8,3
       call      qword ptr [7FFBD4655BC0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       mov       rdx,rsi
       jmp       short M01_L39
M01_L42:
       mov       r8d,r12d
...
M01_L88:
       ...
       mov       rcx,r12
       cmp       [rcx],ecx
       call      qword ptr [7FFBD4780EA0]; Precode of System.Reflection.RuntimeFieldInfo.get_DeclaringType()
       mov       rcx,rax
       mov       rax,[rax]
       mov       rax,[rax+0B0]
       call      qword ptr [rax]
...
M01_L90:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFBD4B149A8]
       mov       rdx,rax
       mov       rcx,rbx
       xor       r8d,r8d
       call      qword ptr [7FFBD474E508]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
M01_L91:
