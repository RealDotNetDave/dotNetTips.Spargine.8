...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.FormatComparison()
       ...
       xor       edx,edx
       mov       r8,312B15445A8
       call      qword ptr [7FFBD476D830]; System.Text.StringBuilder.AppendFormatHelper(System.IFormatProvider, System.String, System.ReadOnlySpan`1<System.Object>)
       mov       [rsp+30],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+30]
       lea       rcx,[rbx+8]
...
M01_L00:
       ...
       call      qword ptr [7FFBD45A43C0]; System.Runtime.CompilerServices.CastHelpers.ChkCastInterface(Void*, System.Object)
       mov       r15,rax
       xor       r13d,r13d
M01_L01:
       mov       r12d,[rsi+8]
       ...
       mov       rcx,[rsp+30]
       mov       r9d,eax
       call      qword ptr [7FFBD48AD380]; System.PackedSpanHelpers.IndexOfAny[[System.SpanHelpers+DontNegate`1[[System.Int16, System.Private.CoreLib]], System.Private.CoreLib]](Int16 ByRef, Int16, Int16, Int32)
       mov       [rsp+8C],eax
       test      eax,eax
       jl        near ptr M01_L25
       cmp       eax,[rsp+70]
...
M01_L05:
       mov       rcx,rbx
       mov       r8d,eax
       call      qword ptr [7FFBD476D998]; System.Text.StringBuilder.AppendWithExpansion(Char ByRef, Int32)
       mov       eax,[rsp+8C]
M01_L06:
       add       r13d,eax
       cmp       r13d,r12d
...
M01_L23:
       ...
       mov       rcx,rbx
       mov       rdx,r12
       call      qword ptr [7FFBD476D1A0]; System.Text.StringBuilder.Append(System.String)
       mov       eax,[rsp+94]
       mov       r8d,eax
       sub       r8d,[r12+8]
       mov       rcx,rbx
       mov       edx,20
       call      qword ptr [7FFBD476D158]
       jmp       near ptr M01_L01
M01_L24:
       sub       r8d,[r12+8]
       mov       rcx,rbx
...
M01_L30:
       ...
       int       3
M01_L31:
       call      qword ptr [7FFBD48A5FB0]
       int       3
M01_L32:
       call      qword ptr [7FFBD48A57E8]
       int       3
M01_L33:
       call      qword ptr [7FFBD48A5F80]
       int       3
M01_L34:
       mov       ecx,2F1
       mov       rdx,7FFBD4454000
...
M01_L36:
       mov       rcx,rbx
       mov       edx,eax
       call      qword ptr [7FFBD476D2D8]; System.Text.StringBuilder.Append(Char)
       inc       r13d
       jmp       near ptr M01_L01
M01_L37:
       lea       eax,[rax+rax*4]
...
M00_L00:
       ...
       mov       rcx,rsi
       xor       r8d,r8d
       call      qword ptr [7FFBD476CFD8]; System.Text.StringBuilder..ctor(System.String, Int32, Int32, Int32)
       mov       ecx,[rsi+1C]
       add       ecx,[rsi+18]
       mov       [rsp+20],ecx
       mov       rcx,rsi
       ...
       mov       r8,2660C830008
       xor       r9d,r9d
       call      qword ptr [7FFBD476D920]; System.Text.StringBuilder.Replace(System.String, System.String, Int32, Int32)
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FFBD47896D0]; System.Text.StringBuilder.ToString()
       mov       [rsp+30],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+30]
       lea       rcx,[rbx+8]
...
M02_L05:
       ...
       mov       [rbp+1C],r10d
       mov       r9d,r10d
       call      qword ptr [7FFBD46551A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       mov       [rbp+34],eax
       test      eax,eax
       jl        near ptr M02_L19
       add       r12d,eax
...
M02_L08:
       ...
       mov       r9d,eax
       mov       r8,r13
       call      qword ptr [7FFBD476D9C8]; System.Text.StringBuilder.ReplaceAllInChunk(System.ReadOnlySpan`1<Int32>, System.Text.StringBuilder, Int32, System.String)
       mov       ecx,[r14+8]
       sub       ecx,[rbp+1C]
       imul      ecx,[rbp+40]
       add       r12d,ecx
...
M02_L12:
       ...
       mov       rcx,[rcx]
       xor       r8d,r8d
       call      qword ptr [7FFBD4D37820]; Precode of System.Buffers.SharedArrayPool`1[[System.Int32, System.Private.CoreLib]].Return(Int32[], Boolean)
M02_L13:
       mov       rax,rdi
       mov       rcx,1DD0CBBD230E
       cmp       [rbp+8],rcx
       je        short M02_L14
...
M02_L15:
       lea       rcx,[rbp+38]
       mov       edx,r12d
       call      qword ptr [7FFBD4D1CFF0]; System.Collections.Generic.ValueListBuilder`1[[System.Int32, System.Private.CoreLib]].AddWithResize(Int32)
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Format()
       ...
       mov       rdx,[rbx+128]
       mov       rcx,1CE8DEA45A8
       call      qword ptr [7FFBD4E4E628]; DotNetTips.Spargine.Core.FastStringBuilder.Format(System.String, System.String[])
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L02:
       ...
       mov       rcx,r14
       xor       edx,edx
       call      qword ptr [7FFBD474D0F8]; System.Text.StringBuilder.set_Length(Int32)
       mov       rdx,r14
       mov       [rbp-40],rdx
       jmp       short M01_L04
M01_L03:
...
M01_L13:
       ...
       lea       rdx,[rbp-28]
       cmp       [rcx],ecx
       call      qword ptr [7FFBD4CFEF10]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].TryDequeue(System.__Canon ByRef)
       test      eax,eax
       je        short M01_L14
       add       rdi,2C
...
M01_L19:
       ...
       mov       rdx,[rbp-40]
       cmp       [rcx],ecx
       call      qword ptr [7FFBD4CFEEE0]; System.Collections.Concurrent.ConcurrentQueue`1[[System.__Canon, System.Private.CoreLib]].Enqueue(System.__Canon)
       jmp       short M01_L21
M01_L20:
       add       rbx,2C
...
; DotNetTips.Spargine.Core.BenchmarkTests.FastStringBuilderBenchmark.Remove()
       ...
       mov       rcx,[rbx+38]
       mov       rdx,204913C45A8
       call      qword ptr [7FFBD4E2E688]; DotNetTips.Spargine.Core.FastStringBuilder.Remove(System.String, System.String)
       mov       [rsp+28],rax
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L01:
       ...
       mov       rcx,r13
       xor       edx,edx
       call      qword ptr [7FFBD481C1F8]; System.Text.StringBuilder.set_Length(Int32)
       mov       [rbp-50],r13
       jmp       short M01_L04
M01_L02:
       mov       rcx,[r15+18]
...
M01_L09:
       ...
       lea       r8,[rsi+0C]
       mov       r9d,r14d
       call      qword ptr [7FFBD46351A0]; System.SpanHelpers.IndexOf(Char ByRef, Int32, Char ByRef, Int32)
       test      eax,eax
       jge       short M01_L14
       jmp       short M01_L13
M01_L10:
       mov       rcx,r13
       mov       r8d,eax
       call      qword ptr [7FFBD481CA98]; System.Text.StringBuilder.AppendWithExpansion(Char ByRef, Int32)
M01_L11:
       mov       r12d,r14d
       add       r12d,r15d
       jo        near ptr M01_L19
...
M01_L27:
       mov       rcx,r13
       call      qword ptr [7FFBD480EB18]; System.Text.StringBuilder.ToString()
       mov       [rbp-58],rax
       mov       rcx,rsp
       call      M01_L29
       nop
