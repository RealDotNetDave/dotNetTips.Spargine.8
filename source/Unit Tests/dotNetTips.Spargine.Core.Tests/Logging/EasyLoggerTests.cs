...
// ***********************************************************************
// <copyright file="EasyLoggerTests.cs" company="dotNetTips.Spargine.Core.Tests">
...
public class EasyLoggerTests
{
	...
	private readonly ILogger _logger = new NullLogger<EasyLoggerTests>();
	...
	[TestMethod]
	public void LogCriticalTest() => EasyLogger.LogCritical(this._logger, message: "Server is down!", exception: this._argumentException);
	...
	[TestMethod]
	public void LogDebugTest() => EasyLogger.LogDebug(this._logger, message: "Test Message");

	[TestMethod]
	public void LogErrorMesageTest() => this._logger.LogErrorMessage(message: "Test Message");

	[TestMethod]
	public void LogErrorTest() => EasyLogger.LogError(this._logger, message: "Test Message");
	...
	[TestMethod]
	public void LogInformationTest() => EasyLogger.LogInformation(this._logger, message: "Test Message");
	...
	{
		EasyLogger.LogTrace(this._logger, message: "Test Message");
	}
