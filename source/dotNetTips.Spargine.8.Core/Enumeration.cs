...
[Information(nameof(Enumeration), Documentation = "http://bit.ly/SpargineFeb2021", Status = Status.NeedsDocumentation)]
...
public class Enumeration : IComparable
{
	...
	private static T Parse<T>(string description, [NotNull] in Func<T, bool> predicate) where T : Enumeration
	{
