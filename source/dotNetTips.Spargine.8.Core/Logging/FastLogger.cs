...
public static partial class FastLogger
{
	...
	[Information(nameof(LogCritical), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
	...
	[Information(nameof(LogDebug), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
	...
	[Information(nameof(LogError), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
	...
	[Information(nameof(LogException), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
	...
	/// <param name="logger">The <see cref="ILogger"/> to use for logging. Must not be null.</param>
	/// <param name="message">The message to log. Must not be null.</param>
	[Information(nameof(LogInformation), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
	...
	/// <param name="logger">The <see cref="ILogger"/> to use for logging. Must not be null.</param>
	/// <param name="message">The message to log. Must not be null.</param>
	[Information(nameof(LogTrace), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
	...
	/// <param name="logger">The <see cref="ILogger"/> to use for logging. Must not be null.</param>
	/// <param name="message">The message to log. Must not be null.</param>
	[Information(nameof(LogWarning), author: "David McCarter", createdOn: "1/1/2022", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.Available)]
