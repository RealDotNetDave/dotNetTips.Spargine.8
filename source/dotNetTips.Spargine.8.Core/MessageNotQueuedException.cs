...
public class MessageNotQueuedException : LoggableException
{
	...
	public MessageNotQueuedException([NotNull] string message) : base(message)
	{
	}
	...
	public MessageNotQueuedException([NotNull] string message, [NotNull] string messageId) : base(message) => this.MessageId = messageId;
	...
	public MessageNotQueuedException([NotNull] string message, [NotNull] Exception innerException) : base(message, innerException)
	{
	}
	...
	/// <param name="messageId">The identifier for the message that was not queued.</param>
	/// <param name="innerException">The exception that is the cause of the current exception, or a null reference if no inner exception is specified.</param>
	public MessageNotQueuedException([NotNull] string message, [NotNull] string messageId, [NotNull] Exception innerException) : base(message, innerException) => this.MessageId = messageId;
	...
	public MessageNotQueuedException([NotNull] string message, [NotNull] Exception ex, [NotNull] string userMessage) : base(message, ex, userMessage)
	{
	}
