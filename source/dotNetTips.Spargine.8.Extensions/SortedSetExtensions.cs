...
public static class SortedSetExtensions
{
	...
	[Information(nameof(ToImmutableSortedSet), "David McCarter", "11/21/2020", BenchMarkStatus = BenchMarkStatus.None, UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
