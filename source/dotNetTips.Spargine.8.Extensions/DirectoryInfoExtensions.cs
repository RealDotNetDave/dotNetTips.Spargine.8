...
public static class DirectoryInfoExtensions
{
	...
	public static long GetSize(this DirectoryInfo path, string searchPattern = ControlChars.WildcardAllFiles, SearchOption searchOption = SearchOption.TopDirectoryOnly)
	{
