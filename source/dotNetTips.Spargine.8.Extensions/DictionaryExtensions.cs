...
public static class DictionaryExtensions
{
	...
	/// <summary>
	/// Converts the dictionary to a lookup function that returns the value for a given key or a default value if the key is not found.
	/// </summary>
	/// <typeparam name="TKey">The type of the keys in the dictionary.</typeparam>
	/// <typeparam name="TValue">The type of the values in the dictionary.</typeparam>
	/// <param name="collection">The dictionary to convert to a lookup function.</param>
	/// <param name="defaultValue">The default value to return if the key is not found.</param>
	/// <returns>A function that takes a key and returns the corresponding value or the default value if the key is not found.</returns>
	/// <exception cref="ArgumentNullException">Thrown if <paramref name="collection"/> is null.</exception>
	[Information("Original code by Simon Painter.", author: "David McCarter", createdOn: "1/3/2025", UnitTestStatus = UnitTestStatus.Completed, BenchmarkStatus = BenchmarkStatus.NotRequired, Status = Status.New)]
	...
	/// <param name="collection">The dictionary to search or add to.</param>
	/// <param name="key">The key of the value to get or add.</param>
	/// <param name="func">The function to generate a value if the key does not exist.</param>
	...
	/// <exception cref="ArgumentNullException">Thrown if <paramref name="collection"/> or <paramref name="func"/> is null.</exception>
	[Information("Original code by Simon Painter.", author: "David McCarter", createdOn: "1/3/2025", UnitTestStatus = UnitTestStatus.Completed, OptimizationStatus = OptimizationStatus.None, BenchmarkStatus = BenchmarkStatus.None, Status = Status.New)]
