...
public static class DictionaryExtensions
{
	...
	public static SortedDictionary<TKey, TValue> ToSortedDictionary<TKey, TValue>([NotNull] this IDictionary<TKey, TValue> collection) => new(collection.ArgumentNotNull());
