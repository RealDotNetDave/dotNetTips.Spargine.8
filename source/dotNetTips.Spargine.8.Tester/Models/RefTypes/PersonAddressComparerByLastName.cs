...
public sealed class PersonAddressComparerByLastName : IComparer<KeyValuePair<string, Person<Address>>>
{
	...
	/// </list>
	/// </returns>
	public int Compare(KeyValuePair<string, Person<Address>> x, KeyValuePair<string, Person<Address>> y) => string.Compare(x.Value.LastName, y.Value.LastName, StringComparison.Ordinal);
}
