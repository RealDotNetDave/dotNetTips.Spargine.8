...
public enum CountryName
{
	...
	/// <summary>
	/// The bonaire sint eustatiusand saba
	/// </summary>
	...
	/// </summary>
	[EnumMember(Value = "Cote D'Ivoire (Ivory Coast)")]
	...
	/// <summary>
	/// The democratic republicofthe congo
	/// </summary>
	...
	/// <summary>
	/// The guernseyand alderney
	/// </summary>
	[EnumMember(Value = "Guernsey and Alderney")]
	GuernseyandAlderney,
	...
	/// The hong kong sar
	/// </summary>
	[EnumMember(Value = "Hong Kong S.A.R.")]
	HongKongSAR,
	...
	/// </summary>
	[EnumMember(Value = "Saint-Barthelemy")]
	SaintBarthelemy,
	...
	/// The south georgia
	/// </summary>
	[EnumMember(Value = "South Georgia")]
	SouthGeorgia,
	...
	/// </summary>
	[EnumMember(Value = "Svalbard And Jan Mayen Islands")]
	...
	/// </summary>
	[EnumMember(Value = "Vatican City State (Holy See)")]
	...
	/// </summary>
	[EnumMember(Value = "Virgin Islands (British)")]
	VirginIslandsBritish,

	/// <summary>
	/// The virgin islands us
	/// </summary>
	[EnumMember(Value = "Virgin Islands (US)")]
	VirginIslandsUS,
