...
public partial class CollectionsBenchmark
{
	...
	protected void LoadPersonRecordCollections()
	{
		...
		ConsoleLogger.Default.WriteLine(LogKind.Info, $"Record List Count = {_personRecordList.Count}: {nameof(CollectionsBenchmark)}.");
		ConsoleLogger.Default.WriteLine(LogKind.Info, $"Record Array Count = {_personRecordArray.Length}: {nameof(CollectionsBenchmark)}.");
	}
